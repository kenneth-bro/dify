const translation = {
  ...
  feature: {
    ...
    citation: {
      ...
      modal: {
        title: 'Citations and Attributions',
        tool: 'Tool with indexed sources',
        dataType: 'Data Type',
        dataTypePlaceholder: 'Please enter data type, e.g., news',
        srcColumn: 'Source Column',
        srcColumnPlaceholder: 'Please enter source column, e.g., source',
        matchColumn: 'Matching Column',
        matchColumnPlaceholder: 'Please enter matching column, e.g., guid',
        showColumn: 'Display Column',
        showColumnPlaceholder: 'Please enter display column, e.g., title',
        toLink: 'Redirect Link',
        toLinkDescription: 'Replace %s dynamically with match_column, e.g., https://fs.investoday.net/xxxx?guid=%s, internal link (starting with /): /pages/to?guid=%s',
        toLinkPlaceholder: 'Please enter redirect link',
      },
      table: {
        name: 'Tool Name',
        dataType: 'Data Type',
