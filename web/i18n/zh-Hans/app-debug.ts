  ...
  feature: {
    ...
    citation: {
      ...
      modal: {
        ...
        tool: '指定有索引来源的工具',
        dataType: '数据类型',
        dataTypePlaceholder: '请输入数据类型，例如 资讯',
        srcColumn: '来源字段',
        srcColumnPlaceholder: '请输入来源字段，例如 source',
        matchColumn: '索引的匹配字段',
        matchColumnPlaceholder: '请输入匹配字段，例如 guid',
        showColumn: '展示字段',
        showColumnPlaceholder: '请输入展示字段，例如 title',
        toLink: '跳转链接',
        toLinkDescription: '其中%s动态替换为 match_column 例如 https://fs.investoday.net/xxxx?guid=%s，内部链接（以/开头): /pages/to?guid=%s',
